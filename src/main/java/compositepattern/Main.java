...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CompositeProduct gammerPC = new CompositeProduct("Gammer PC", "De la casa");
    ...
    CompositeProduct homePC = new CompositeProduct("Casa PC", "De la casa");
    ...
    CompositeProduct pc2x1 = new CompositeProduct("Paquete PC Gammer + Casa", "De la casa");
    ...
    SaleOrder onlyProduct = new SaleOrder(5, "Luis Conde");
    onlyProduct.addProduct(gammerMouse);
    onlyProduct.printOrder();
  }
}
